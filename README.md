...
3. Run the db service - `docker-compose up db`. This will setup the database.
4. Run the migrate service - `docker-compose up migrate`. This will run the DB migrations which are part of the repo.
5. Run `go run ./...`. This will run the gin server locally on port `8082`.
